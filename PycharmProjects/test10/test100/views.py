...
try:
    from barcodeimg.writer import ImageWriter
except ImportError:
    ImageWriter = None
...
def detail(request, item_id):
    try:
        ...
        return render(request, 'test100/detail.html', {'item': item})
    except:
        raise Http404
...
def newitem(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'test100/newitem.html', {'form': form, 'suggestions': suggestionss})
    else:
        form = SuggestionForm()
        return render(request, 'test100/newitem.html', {'form': form, 'suggestions': suggestionss})
